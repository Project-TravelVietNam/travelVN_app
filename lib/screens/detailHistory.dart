  ...
  Future<void> _loadFavoriteStatus() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final histories = List<Map<String, dynamic>>.from(data['histories'] ?? []);
        final currentId = widget.location['_id'].toString();
        
        setState(() {
          isFavorite = histories.any((item) => item['_id'].toString() == currentId);
        });
      }
    } catch (e) {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            buildCommentSection('Khoai Lang Thang', '3 giờ 15 phut trước', 'assets/images/user1.png', 4, 'Ở đây có rất nhiều địa điểm để khám phá du lịch.'),
